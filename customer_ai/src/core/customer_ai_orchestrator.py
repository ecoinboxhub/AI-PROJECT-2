...
from .appointment_booking_handler import get_appointment_booking_handler
...
class CustomerAIOrchestrator:
    ...
    def __init__(self):
        ...
        # Conversation managers for each business
    ...
    def onboard_business(self, business_id: str, business_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            # Step 5: Generate FAQs from business data
            faqs = business_ai.generate_faqs_from_business_data()
            
            # Step 6: Generate AI context from minimal data
            ai_context = business_ai.generate_ai_context_from_minimal_data()
            
            # Step 7: Store business AI instance
            self.business_ais[business_id] = business_ai
            
            # Step 8: Create default conversation manager for this business (with industry for escalation)
    ...
    def _get_or_build_graph(self, business_id: str):
        ...
        booking_handler = get_appointment_booking_handler(business_id)
        ...
        self.agent_graphs[business_id] = graph
    ...
    def process_customer_message(
        ...
        try:
            ...
            compiled_graph = self._get_or_build_graph(business_id)

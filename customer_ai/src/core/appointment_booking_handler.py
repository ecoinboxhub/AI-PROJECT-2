"""
Appointment Booking Handler for Customer AI
- Check availability via working hours + existing appointments
- Create appointments via POST /api/bookings/appointments/
"""
